...
const sStylesheet = createStyleSheet(theme => ({
      ...
      locationPill: { flex:1, flexDirection:'row', alignItems:'center', backgroundColor:'rgba(0,0,0,0.5)', borderRadius:14, paddingHorizontal:12, paddingVertical:8, borderWidth:1, borderColor:theme.colors.GLASS_BORDER },
      locationPillTxt: { color:theme.colors.TEXT_PRIMARY, fontWeight:'600', fontSize:13, marginLeft:6, fontFamily: 'Inter-SemiBold' },
      ...
      searchInput: { flex:1, color:theme.colors.TEXT_PRIMARY, fontFamily:'Inter-Regular', fontSize:13, marginRight:8, padding:0 },
...
const msStylesheet = createStyleSheet(theme => ({
      ...
      iBox: { width:40, height:40, borderRadius:12, alignItems:'center', justifyContent:'center', borderWidth:1, borderColor:theme.colors.GLASS_BORDER },
      dot: { width:8, height:8, borderRadius:4, marginTop:2 },
      cluster: { width:44, height:44, borderRadius:22, backgroundColor:'#82DB7E', alignItems:'center', justifyContent:'center', borderWidth:3, borderColor:theme.colors.TEXT_PRIMARY },
